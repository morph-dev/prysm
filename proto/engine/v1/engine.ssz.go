...
func (e *ExecutionPayloadGloas) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = append(dst, e.BlockAccessListHash...)
...
func (e *ExecutionPayloadGloas) UnmarshalSSZ(buf []byte) error {
	...
	// Field (13) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[504:512])
...
func (e *ExecutionPayloadGloas) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	hh.PutBytes(e.BlockAccessListHash)
...
// MarshalSSZ ssz marshals the ExecutionChunkHeader object
func (e *ExecutionChunkHeader) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionChunkHeader object to a target array
func (e *ExecutionChunkHeader) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'Index'
	dst = ssz.MarshalUint64(dst, e.Index)

	// Field (1) 'ChunkAccessListHash'
	if size := len(e.ChunkAccessListHash); size != 32 {
		err = ssz.ErrBytesLengthFn("--.ChunkAccessListHash", size, 32)
		return
	}
	dst = append(dst, e.ChunkAccessListHash...)

	// Field (2) 'PreChunkTxCount'
	dst = ssz.MarshalUint64(dst, e.PreChunkTxCount)

	// Field (3) 'PreChunkGasUsed'
	dst = ssz.MarshalUint64(dst, e.PreChunkGasUsed)

	// Field (4) 'PreChunkBlobGasUsed'
	dst = ssz.MarshalUint64(dst, e.PreChunkBlobGasUsed)

	// Field (5) 'TxsRoot'
	if size := len(e.TxsRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("--.TxsRoot", size, 32)
		return
	}
	dst = append(dst, e.TxsRoot...)
...
// UnmarshalSSZ ssz unmarshals the ExecutionChunkHeader object
func (e *ExecutionChunkHeader) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 144 {
		return ssz.ErrSize
	...
	// Field (0) 'Index'
	e.Index = ssz.UnmarshallUint64(buf[0:8])

	// Field (1) 'ChunkAccessListHash'
	if cap(e.ChunkAccessListHash) == 0 {
		e.ChunkAccessListHash = make([]byte, 0, len(buf[8:40]))
	}
	e.ChunkAccessListHash = append(e.ChunkAccessListHash, buf[8:40]...)

	// Field (2) 'PreChunkTxCount'
	e.PreChunkTxCount = ssz.UnmarshallUint64(buf[40:48])

	// Field (3) 'PreChunkGasUsed'
	e.PreChunkGasUsed = ssz.UnmarshallUint64(buf[48:56])

	// Field (4) 'PreChunkBlobGasUsed'
	e.PreChunkBlobGasUsed = ssz.UnmarshallUint64(buf[56:64])

	// Field (5) 'TxsRoot'
	if cap(e.TxsRoot) == 0 {
		e.TxsRoot = make([]byte, 0, len(buf[64:96]))
	}
	e.TxsRoot = append(e.TxsRoot, buf[64:96]...)

	// Field (6) 'GasUsed'
	e.GasUsed = ssz.UnmarshallUint64(buf[96:104])

	// Field (7) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[104:112])

	// Field (8) 'WithdrawalsRoot'
	if cap(e.WithdrawalsRoot) == 0 {
		e.WithdrawalsRoot = make([]byte, 0, len(buf[112:144]))
	}
	e.WithdrawalsRoot = append(e.WithdrawalsRoot, buf[112:144]...)

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ExecutionChunkHeader object
func (e *ExecutionChunkHeader) SizeSSZ() (size int) {
	size = 144
	return
}

// HashTreeRoot ssz hashes the ExecutionChunkHeader object
func (e *ExecutionChunkHeader) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionChunkHeader object with a hasher
func (e *ExecutionChunkHeader) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'Index'
	hh.PutUint64(e.Index)
	...
	hh.PutBytes(e.ChunkAccessListHash)

	// Field (2) 'PreChunkTxCount'
	hh.PutUint64(e.PreChunkTxCount)

	// Field (3) 'PreChunkGasUsed'
	hh.PutUint64(e.PreChunkGasUsed)

	// Field (4) 'PreChunkBlobGasUsed'
	hh.PutUint64(e.PreChunkBlobGasUsed)
...
// MarshalSSZ ssz marshals the ExecutionChunk object
func (e *ExecutionChunk) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionChunk object to a target array
func (e *ExecutionChunk) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(152)

	// Field (0) 'ChunkHeader'
	if e.ChunkHeader == nil {
		e.ChunkHeader = new(ExecutionChunkHeader)
	}
	if dst, err = e.ChunkHeader.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the ExecutionChunk object
func (e *ExecutionChunk) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 152 {
		return ssz.ErrSize
	...
	if err = e.ChunkHeader.UnmarshalSSZ(buf[0:144]); err != nil {
		return err
	}

	// Offset (1) 'Transactions'
	if o1 = ssz.ReadOffset(buf[144:148]); o1 > size {
		return ssz.ErrOffset
	}
	...
	// Offset (2) 'Withdrawals'
	if o2 = ssz.ReadOffset(buf[148:152]); o2 > size || o1 > o2 {
		return ssz.ErrOffset
	}
...
// SizeSSZ returns the ssz encoded size in bytes for the ExecutionChunk object
func (e *ExecutionChunk) SizeSSZ() (size int) {
	size = 152
...
// HashTreeRoot ssz hashes the ExecutionChunk object
func (e *ExecutionChunk) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionChunk object with a hasher
func (e *ExecutionChunk) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'ChunkHeader'
	if err = e.ChunkHeader.HashTreeRootWith(hh); err != nil {
		return
	}
...
// MarshalSSZ ssz marshals the ExecutionChunkBundle object
func (e *ExecutionChunkBundle) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionChunkBundle object to a target array
func (e *ExecutionChunkBundle) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(156)
	...
	// Offset (3) 'ChunkAccessList'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(e.ChunkAccessList)
	...
	// Field (3) 'ChunkAccessList'
	if size := len(e.ChunkAccessList); size > 16777216 {
		err = ssz.ErrBytesLengthFn("--.ChunkAccessList", size, 16777216)
		return
	}
	dst = append(dst, e.ChunkAccessList...)

	return
}

// UnmarshalSSZ ssz unmarshals the ExecutionChunkBundle object
func (e *ExecutionChunkBundle) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 156 {
		return ssz.ErrSize
	...
	// Offset (3) 'ChunkAccessList'
	if o3 = ssz.ReadOffset(buf[152:156]); o3 > size || o2 > o3 {
		return ssz.ErrOffset
	}
	...
	// Field (3) 'ChunkAccessList'
	{
		...
		if cap(e.ChunkAccessList) == 0 {
			e.ChunkAccessList = make([]byte, 0, len(buf))
		}
		e.ChunkAccessList = append(e.ChunkAccessList, buf...)
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ExecutionChunkBundle object
func (e *ExecutionChunkBundle) SizeSSZ() (size int) {
	size = 156
	...
	// Field (3) 'ChunkAccessList'
	size += len(e.ChunkAccessList)

	return
}

// HashTreeRoot ssz hashes the ExecutionChunkBundle object
func (e *ExecutionChunkBundle) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionChunkBundle object with a hasher
func (e *ExecutionChunkBundle) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(e.ChunkAccessList))
		if byteLen > 16777216 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(e.ChunkAccessList)
